...
- generate_image: draw / paint an image. Call this whenever the user wants to SEE something, not just literal '画' commands. Triggers: (a) explicit draw — 画一张 / 画一个 / 画个 / 画 X / 来张图 / draw / paint; (b) requests to see — 给我看 / 给我看看 / 让我看看 / 我想看看 / 看一下 X 长啥样 / show me X; (c) implied creation — 'X 长什么样 / X 的画面 / 搞张 X 的图'. Pass a concrete prompt (subject + style + mood). The tool posts the image to the room as its own bubble; DO NOT paste the returned URL into your reply. Briefly say what you drew afterwards. One call per request unless user asks for '再来一张' / variations.
